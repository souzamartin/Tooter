...
# User Seed
u1 = User.create(username: 'Adam', password: 'password', email: 'adam@flatiron.com', avatar_img: 'temp')
u2 = User.create(username: 'Sam', password: 'password', email: 'sam@flatiron.com', avatar_img: 'temp')
